...
let preguntas = [
 {
     pregunta : "¿Cuál es la principal causa de deforestación en el mundo?",
     imgSrc : "https://i.gifer.com/embedded/download/HUNJ.gif",
     opA : "La producción de carne para consumo humano.",
     opB : "Incendios.",
     opC : "Tala inmoderada.",
     correct : "A"
 },{
     pregunta : "¿De qué alimentos se desperdicia a nivel mundial, más del 45% del total de lo que se produce?",
     imgSrc : "http://olegif.com/bin/gifs/00/37/43.gif",
     opA : "Carne de corte vacuno y porcino.",
     opB : "Frutas, hortalizas, raíces y tubérculos.",
     opC : "Legumbres y cereales.",
     correct : "B"
 },{
     pregunta : "¿A cuántos países exporta alimentos, México?",
     imgSrc : "https://media1.giphy.com/media/xUPGcuomRFMUcsB9nO/giphy.gif",
     opA : "A 95 países.",
     opB : "A 230 países.",
     opC : "A 190 países.",
     correct : "C"
